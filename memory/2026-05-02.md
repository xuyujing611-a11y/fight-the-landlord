...
## 三批1320适配（晚）
### 第一批: 底层引擎+核心卡牌
- GameConfig: width 960→1320, resolution: devicePixelRatio
- drawTableBackground: W=1320, cx=660, 装饰元素重定位
- renderPlayerHand: cw=84, ch=120, overlap=min(45, (1000-84)/(n-1)), baseY=370, 弧线恢复, y±24
- displayPlay: 玩家(660,195) 75×108, AI1(360,133) 63×90, AI2(960,133) 63×90, maxPlayZoneW=600

### 第二批: 全局UI+触控
- createTopBar: 背景1320, AI1(240) AI2(1080), 状态660居中
- createActionButtons: 100×60, gap=20, btnY=420, center 660
- showBiddingUI: cx=660, 按钮110×60, gap=20
- renderRoundEndPanel: 遮罩1320, 卡片(380,60), 各项+180偏移

### 第三批: 搞事情+气泡+边角
- _createChaosOverlay: 卡片居中330, 内部+180
- _showTypeSelection/_renderQuestion: 坐标+180
- _showPlayBubble: 头像240/1080, 气泡270/动态
- _showAiBubble: 头像260, 气泡390
- _showSwapUI/_showSwapResult: 按钮居中, 手牌新参数
- createPlayHistoryArea: 1150
- showToast: cx=660
